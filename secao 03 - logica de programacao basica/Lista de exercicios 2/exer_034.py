...
print(f'\033[1;33mPara pegar uma casa de \033[mR${casa:,.2f}\033[1;33m em {anos} anos a prestacao sera de\033[m R${prestacao:.2f}')
if prestacao <= (salario * 30 / 100): # prestacao <= 30% salario
